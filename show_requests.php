        ...
        //                    $business = $db->runQuery('*', BUSINESS, "id=".$user['business_id']);
                            ?> 
                              <tr>
                                <td><?= $count; ?></td>
                                <td><?= $request['email'] ?></td>
                                <td><button type="button"  class="btn btn-primary btn-sm" onclick="showMessage(this)" id="<?= $request['booking_msg']; ?>">View</button></td>
                                <td>
                                ...
                                <?php } ?>
                                 ...
                                 <td> 
                                    ...
                                    <td><?php if($request['cancellation']==1){ ?><a class="btn btn-danger" href="javascript:;">No</a>
                                     ...
                                     <?php }?></td>
                                    <td><?php if($request['invoice_id']==''){ ?><a class="btn btn-danger" href="javascript:;">Pending</a>
                                     <?php } else{ ?>
                                     <a class="btn btn-info" href="javascript:;">Done</a>
                                     <?php }?></td>
                                     <td><?php if($request['cancellation']==0){ ?>
                                        <a class="btn btn-info" href="javascript:;">Confirm</a>
                                        
                                     <?php } else{ ?>
                                     <a class="btn btn-danger" href="javascript:;">Cancellation</a>
                                     <?php }?></td>
                               <!--  <td>
