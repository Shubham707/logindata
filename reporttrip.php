...
$db = new MysqlDB;
$db->connect();
$from=$_POST['booking_from']; 
$to=$_POST['booking_to'];

if($from AND $to)
{

   $requests = $db->runBetween('*', 'booking', $from, $to);
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                <div class="row">
                 <div class="col-lg-12">
                    <form name="frmdata" action="reporttrip.php" id="searching" method="post"> 
                        <div class="form-group has-success col-lg-4">
                            <label for="place" class="control-label mb-1">From</label>
                            <input type="date"  id="booking_from" name="booking_from" class="form-control date" >
                        </div>
                        <div class="form-group has-success col-lg-4">
                            <label for="place" class="control-label mb-1">To</label>
                            <input type="date" id="booking_to" name="booking_to" class="form-control"> 
                        </div>
                        <div class="form-group has-success col-lg-4">
                            <label for="place" class="control-label mb-1"></label>
                             <input type="submit"  name="search" class="form-control btn btn-info" value="Search"> 
                        </div>
                    </form>
                 </div>
                            ...
                            ?> 
                              <tr>
                                ...
                                <?php } ?>
                                 ...
                                 <td><?php echo $request['current_date_time'];?></td>
                                    <td><?php if($request['cancellation']==1){ ?><a class="btn btn-danger" href="javascript:;">No</a>
                                     <?php } else{ ?>
    ...
    <script type="text/javascript">
     ...
     /*$(document).ready(function (e) {
            $("#searching").on('submit', (function (e) {
                ...
                e.preventDefault();
                var formData = new FormData($(this)[0]);
                //alert(formData['booking_from']+''+formData['booking_to']);
                $.ajax({
                    url: "searching.php",
                    type: "POST",
                    data: formData,
